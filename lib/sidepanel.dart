...
{
    const SidePanel(this.page, {super.key});
    ...
    List<Widget> getButtons(BuildContext context) {
        ...
        const Color buttonTextColor = Color.fromARGB(255, 113, 169, 180); // button text color
            ...
            case SidePanelPage.home:
                buttons.add(
                    ElevatedButton(
                        ...
                        style: ButtonStyle( backgroundColor: WidgetStateProperty.all<Color>(buttonColor), ),
                        child: const Text('settings', style: TextStyle(color: buttonTextColor)),
                    ),
                );
                break;
