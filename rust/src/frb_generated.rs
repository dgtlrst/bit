...
fn wire__crate__api__controller__Controller_end_stream_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "Controller_end_stream",
            port: None,
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync,
        },
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let mut api_that_guard = api_that_guard.unwrap();
                let output_ok = Result::<_, ()>::Ok({
                    crate::api::controller::Controller::end_stream(
                        &mut *api_that_guard,
                        api_thread_id,
                    );
                })?;
...
fn wire__crate__api__controller__Controller_set_new_thread_id_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "Controller_set_new_thread_id",
            port: None,
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync,
        },
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let mut api_that_guard = api_that_guard.unwrap();
                let output_ok = Result::<_, ()>::Ok({
                    crate::api::controller::Controller::set_new_thread_id(
                        &mut *api_that_guard,
                        api_thread_id,
                    );
                })?;
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__controller__Controller_end_stream_impl(ptr, rust_vec_len, data_len),
        ...
        5 => wire__crate__api__controller__Controller_set_new_thread_id_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
